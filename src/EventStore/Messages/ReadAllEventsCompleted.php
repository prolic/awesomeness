...
/**
 * Generated from protobuf message <code>Prooph.EventStore.Messages.ReadAllEventsCompleted</code>
 */
class ReadAllEventsCompleted extends \Google\Protobuf\Internal\Message
{
    ...
    /**
     * Generated from protobuf field <code>repeated .Prooph.EventStore.Messages.ResolvedEvent events = 3;</code>
     */
    private $events;
    /**
    ...
    /**
     * Generated from protobuf field <code>.Prooph.EventStore.Messages.ReadAllEventsCompleted.ReadAllResult result = 6;</code>
     */
    private $result = 0;
    /**
    ...
    /**
     * Generated from protobuf field <code>repeated .Prooph.EventStore.Messages.ResolvedEvent events = 3;</code>
     * @param \Prooph\EventStore\Messages\ResolvedEvent[]|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setEvents($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Prooph\EventStore\Messages\ResolvedEvent::class);
        $this->events = $arr;
    ...
    {
        GPBUtil::checkEnum($var, \Prooph\EventStore\Messages\ReadAllEventsCompleted_ReadAllResult::class);
        $this->result = $var;
