...
/**
 * Generated from protobuf message <code>Prooph.EventStore.Messages.TransactionCommitCompleted</code>
 */
class TransactionCommitCompleted extends \Google\Protobuf\Internal\Message
{
    ...
    /**
     * Generated from protobuf field <code>.Prooph.EventStore.Messages.OperationResult result = 2;</code>
     */
    private $result = 0;
    /**
    ...
    {
        GPBUtil::checkEnum($var, \Prooph\EventStore\Messages\OperationResult::class);
        $this->result = $var;
