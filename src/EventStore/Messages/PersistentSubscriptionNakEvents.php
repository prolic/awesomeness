...
/**
 * Generated from protobuf message <code>Prooph.EventStore.Messages.PersistentSubscriptionNakEvents</code>
 */
class PersistentSubscriptionNakEvents extends \Google\Protobuf\Internal\Message
{
    ...
    private $message = '';
    /**
     * Generated from protobuf field <code>.Prooph.EventStore.Messages.PersistentSubscriptionNakEvents.NakAction action = 4;</code>
     */
    private $action = 0;
    ...
    {
        GPBUtil::checkEnum($var, \Prooph\EventStore\Messages\PersistentSubscriptionNakEvents_NakAction::class);
        $this->action = $var;
