...
/**
 * Generated from protobuf message <code>Prooph.EventStore.Messages.ReadStreamEventsCompleted</code>
 */
class ReadStreamEventsCompleted extends \Google\Protobuf\Internal\Message
{
    /**
     * Generated from protobuf field <code>repeated .Prooph.EventStore.Messages.ResolvedIndexedEvent events = 1;</code>
     */
    private $events;
    /**
     * Generated from protobuf field <code>.Prooph.EventStore.Messages.ReadStreamEventsCompleted.ReadStreamResult result = 2;</code>
     */
    private $result = 0;
    /**
    ...
    /**
     * Generated from protobuf field <code>repeated .Prooph.EventStore.Messages.ResolvedIndexedEvent events = 1;</code>
     * @param \Prooph\EventStore\Messages\ResolvedIndexedEvent[]|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setEvents($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Prooph\EventStore\Messages\ResolvedIndexedEvent::class);
        $this->events = $arr;
    ...
    {
        GPBUtil::checkEnum($var, \Prooph\EventStore\Messages\ReadStreamEventsCompleted_ReadStreamResult::class);
        $this->result = $var;
