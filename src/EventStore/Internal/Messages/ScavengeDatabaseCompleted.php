...
/**
 * Generated from protobuf message <code>Prooph.EventStore.Internal.Messages.ScavengeDatabaseCompleted</code>
 */
class ScavengeDatabaseCompleted extends \Google\Protobuf\Internal\Message
{
    /**
     * Generated from protobuf field <code>.Prooph.EventStore.Internal.Messages.ScavengeDatabaseCompleted.ScavengeResult result = 1;</code>
     */
    private $result = 0;
    /**
    ...
    {
        GPBUtil::checkEnum($var, \Prooph\EventStore\Internal\Messages\ScavengeDatabaseCompleted_ScavengeResult::class);
        $this->result = $var;
