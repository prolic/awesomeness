...
/**
 * Generated from protobuf message <code>Prooph.EventStore.Internal.Messages.TransactionCommitCompleted</code>
 */
class TransactionCommitCompleted extends \Google\Protobuf\Internal\Message
{
    ...
    /**
     * Generated from protobuf field <code>.Prooph.EventStore.Internal.Messages.OperationResult result = 2;</code>
     */
    private $result = 0;
    /**
    ...
    {
        GPBUtil::checkEnum($var, \Prooph\EventStore\Internal\Messages\OperationResult::class);
        $this->result = $var;
