...
/**
 * Generated from protobuf message <code>Prooph.EventStore.Internal.Messages.ReadStreamEventsCompleted</code>
 */
class ReadStreamEventsCompleted extends \Google\Protobuf\Internal\Message
{
    /**
     * Generated from protobuf field <code>repeated .Prooph.EventStore.Internal.Messages.ResolvedIndexedEvent events = 1;</code>
     */
    private $events;
    /**
     * Generated from protobuf field <code>.Prooph.EventStore.Internal.Messages.ReadStreamEventsCompleted.ReadStreamResult result = 2;</code>
     */
    private $result = 0;
    /**
    ...
    /**
     * Generated from protobuf field <code>repeated .Prooph.EventStore.Internal.Messages.ResolvedIndexedEvent events = 1;</code>
     * @param \Prooph\EventStore\Internal\Messages\ResolvedIndexedEvent[]|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setEvents($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Prooph\EventStore\Internal\Messages\ResolvedIndexedEvent::class);
        $this->events = $arr;
    ...
    {
        GPBUtil::checkEnum($var, \Prooph\EventStore\Internal\Messages\ReadStreamEventsCompleted_ReadStreamResult::class);
        $this->result = $var;
