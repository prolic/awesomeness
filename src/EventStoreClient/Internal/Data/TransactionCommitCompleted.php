...
/**
 * Generated from protobuf message <code>Prooph.EventStoreClient.Internal.Data.TransactionCommitCompleted</code>
 */
class TransactionCommitCompleted extends \Google\Protobuf\Internal\Message
{
    ...
    /**
     * Generated from protobuf field <code>.Prooph.EventStoreClient.Internal.Data.OperationResult result = 2;</code>
     */
    private $result = 0;
    /**
    ...
    {
        GPBUtil::checkEnum($var, \Prooph\EventStoreClient\Internal\Data\OperationResult::class);
        $this->result = $var;
