...
/**
 * Generated from protobuf message <code>Prooph.EventStoreClient.Internal.Data.PersistentSubscriptionNakEvents</code>
 */
class PersistentSubscriptionNakEvents extends \Google\Protobuf\Internal\Message
{
    ...
    private $message = '';
    /**
     * Generated from protobuf field <code>.Prooph.EventStoreClient.Internal.Data.PersistentSubscriptionNakEvents.NakAction action = 4;</code>
     */
    private $action = 0;
    ...
    {
        GPBUtil::checkEnum($var, \Prooph\EventStoreClient\Internal\Data\PersistentSubscriptionNakEvents_NakAction::class);
        $this->action = $var;
