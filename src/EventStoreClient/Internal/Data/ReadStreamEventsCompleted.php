...
/**
 * Generated from protobuf message <code>Prooph.EventStoreClient.Internal.Data.ReadStreamEventsCompleted</code>
 */
class ReadStreamEventsCompleted extends \Google\Protobuf\Internal\Message
{
    /**
     * Generated from protobuf field <code>repeated .Prooph.EventStoreClient.Internal.Data.ResolvedIndexedEvent events = 1;</code>
     */
    private $events;
    /**
     * Generated from protobuf field <code>.Prooph.EventStoreClient.Internal.Data.ReadStreamEventsCompleted.ReadStreamResult result = 2;</code>
     */
    private $result = 0;
    /**
    ...
    /**
     * Generated from protobuf field <code>repeated .Prooph.EventStoreClient.Internal.Data.ResolvedIndexedEvent events = 1;</code>
     * @param \Prooph\EventStoreClient\Internal\Data\ResolvedIndexedEvent[]|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setEvents($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Prooph\EventStoreClient\Internal\Data\ResolvedIndexedEvent::class);
        $this->events = $arr;
    ...
    {
        GPBUtil::checkEnum($var, \Prooph\EventStoreClient\Internal\Data\ReadStreamEventsCompleted_ReadStreamResult::class);
        $this->result = $var;
