...
/**
 * Generated from protobuf message <code>Prooph.EventStoreClient.Internal.Messages.ReadAllEventsCompleted</code>
 */
class ReadAllEventsCompleted extends \Google\Protobuf\Internal\Message
{
    ...
    /**
     * Generated from protobuf field <code>repeated .Prooph.EventStoreClient.Internal.Messages.ResolvedEvent events = 3;</code>
     */
    private $events;
    /**
    ...
    /**
     * Generated from protobuf field <code>.Prooph.EventStoreClient.Internal.Messages.ReadAllEventsCompleted.ReadAllResult result = 6;</code>
     */
    private $result = 0;
    /**
    ...
    /**
     * Generated from protobuf field <code>repeated .Prooph.EventStoreClient.Internal.Messages.ResolvedEvent events = 3;</code>
     * @param \Prooph\EventStoreClient\Internal\Messages\ResolvedEvent[]|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setEvents($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Prooph\EventStoreClient\Internal\Messages\ResolvedEvent::class);
        $this->events = $arr;
    ...
    {
        GPBUtil::checkEnum($var, \Prooph\EventStoreClient\Internal\Messages\ReadAllEventsCompleted_ReadAllResult::class);
        $this->result = $var;
