...
/**
 * Generated from protobuf message <code>Prooph.EventStoreClient.Internal.Messages.ScavengeDatabaseCompleted</code>
 */
class ScavengeDatabaseCompleted extends \Google\Protobuf\Internal\Message
{
    /**
     * Generated from protobuf field <code>.Prooph.EventStoreClient.Internal.Messages.ScavengeDatabaseCompleted.ScavengeResult result = 1;</code>
     */
    private $result = 0;
    /**
    ...
    {
        GPBUtil::checkEnum($var, \Prooph\EventStoreClient\Internal\Messages\ScavengeDatabaseCompleted_ScavengeResult::class);
        $this->result = $var;
