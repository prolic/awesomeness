...
/**
 * Generated from protobuf message <code>Prooph.EventStoreClient.Data.TransactionCommitCompleted</code>
 */
class TransactionCommitCompleted extends \Google\Protobuf\Internal\Message
{
    ...
    /**
     * Generated from protobuf field <code>.Prooph.EventStoreClient.Data.OperationResult result = 2;</code>
     */
    private $result = 0;
    /**
    ...
    {
        GPBUtil::checkEnum($var, \Prooph\EventStoreClient\Data\OperationResult::class);
        $this->result = $var;
